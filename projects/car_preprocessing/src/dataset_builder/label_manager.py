...
class LabelManager:
    def __init__(self, annotations_dir):
        print(f"\n[LabelManager] Initialisation dans {annotations_dir}")
        self.annotations_dir = annotations_dir
        os.makedirs(annotations_dir, exist_ok=True)

    def save_annotation(self, image_name, bbox, mask_path, labels=None):
        print(f"[LabelManager] Sauvegarde annotation JSON pour {image_name}")
        ...
        print(f"[LabelManager] Annotation sauvegardée → {json_path}")
